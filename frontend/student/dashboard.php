  ...
  <div class="col-md-4">
    <div class="card p-3 card-lean">
      ...
      <div class="list-group">
        <a class="list-group-item" href="feedback_form.php">Submit Feedback</a>
        <a class="list-group-item" href="verify_assessment.php">Verify Assessments</a>
        <a class="list-group-item" href="verify_event.php">Verify Events</a>
